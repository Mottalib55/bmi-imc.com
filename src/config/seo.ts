...
export const defaultSEO: PageSEO[] = [
  ...
  // --- 中文 ---
  {
    ...
    description: "在线免费计算您的身体质量指数BMI，10秒获取WHO世界卫生组织标准分类结果。了解您身高对应的健康体重范围、超重和肥胖的健康风险等级，并获取基于科学数据的个性化饮食和运动改善建议，轻松管理体重。",
  },
  {
    path: "/zh/bmi-nanxing",
    lang: "zh",
    title: "男性BMI计算器 — 按身高年龄查理想体重表",
    description: "专为男性设计的BMI计算器，输入身高体重即可查看您的理想体重范围。包含20至60岁各年龄段BMI对照表、男性腰围安全标准值，以及腹部肥胖对心血管和代谢健康的风险分析与实用改善方案。",
  },
  {
    path: "/zh/bmi-nvxing",
    lang: "zh",
    title: "女性BMI计算器 — 理想体重与激素影响全面分析",
    description: "考虑女性特有激素变化因素的BMI计算器，精准评估您的身体质量指数。按身高查询理想体重范围、孕期合理体重增长指南、更年期对体重和体脂分布的影响，以及青春期到更年期各生命阶段的科学体重管理建议。",
  },
  {
    path: "/zh/bmi-yundongyuan",
    lang: "zh",
    title: "运动员BMI — 为什么肌肉多的人BMI结果不准确",
    description: "传统BMI指数会严重高估肌肉发达者的体脂率，导致运动员被误判为超重或肥胖。深入了解FFMI去脂体重指数的科学原理和计算方法，以及运动员、健身爱好者和力量训练者评估真实身体成分的精准医学替代方法。",
  },
  {
    path: "/zh/bmi-ertong",
    lang: "zh",
    title: "儿童BMI计算器 — 按年龄性别查WHO百分位数",
    description: "使用WHO世界卫生组织官方生长曲线在线计算儿童和青少年BMI百分位数。提供2至18岁按年龄和性别的精确评估结果、各阶段健康体重范围标准，以及当孩子体重偏离正常时何时需要就医的专业儿科指导建议。",
  },
  {
    path: "/zh/bmi-biao",
    lang: "zh",
    title: "BMI对照表完整版 — WHO标准分类含体重示例",
    description: "基于WHO世界卫生组织标准的完整BMI身体质量指数分类对照表。详细列出偏瘦、正常体重、超重、一级至三级肥胖各类别的精确阈值数值，并为每个身高段提供对应体重示例，标注各等级的健康风险程度和医学建议。",
  },
  {
    path: "/zh/bmi-jiedu",
    lang: "zh",
    title: "BMI结果解读 — 你的数字对健康意味着什么",
    description: "深入理解您的BMI数值对健康风险的实际含义和医学意义。从偏瘦到严重肥胖逐类别详细解读，明确何时需要警惕、何时应立即采取行动就医，以及年龄、性别、肌肉量等哪些因素会影响BMI结果的准确性。",
  },
  {
    path: "/zh/bmi-juxianxing",
    lang: "zh",
    title: "BMI局限性 — 7种人群的BMI结果不可靠",
    description: "BMI身体质量指数对运动员、孕妇、老年人和特定族群的评估结果不够准确，可能造成健康误判。详细了解7种常见情况下BMI会误导你的健康判断，以及体脂率、腰臀比等哪些医学替代指标能更真实地反映你的健康状况。",
  },
  {
    path: "/zh/bmi-changjianwenti",
    lang: "zh",
    title: "BMI常见问题解答 — 计算公式、正常范围、实用建议",
    description: "关于BMI身体质量指数最常见问题的清晰专业解答。包括如何正确计算BMI、各年龄段的正常范围是多少、BMI是否适用于你的身体情况，以及在哪些特殊场景下应该使用体脂率等其他健康评估指标来替代BMI。",
  },
  {
    path: "/zh/jiankang-tizhong",
    lang: "zh",
    title: "健康体重管理指南 — 科学饮食与运动建议",
    description: "基于循证医学研究指导的科学健康体重管理全方案。涵盖均衡营养饮食建议、每周推荐运动类型和运动量、日常份量控制实用技巧，以及帮助你建立可持续长期体重维护习惯的行为策略，实现科学减重不反弹的目标。",
  },
  // --- Utility pages ---
  {
    path: "/glossary",
