...
const DomandeFrequentiIMC = () => {
  const faqs = [
    ...
    { question: "L'IMC è uguale per tutte le etnie?", answer: "No. L'<strong>OMS</strong> ha stabilito soglie più basse per le popolazioni asiatiche: il sovrappeso inizia a un IMC di <strong>23</strong> (anziché 25) e l'obesità a 27,5 (anziché 30). Questo perché a parità di IMC, le persone di origine asiatica tendono ad avere più grasso viscerale e rischi cardiometabolici più elevati. In Italia, con una popolazione multietnica in crescita, i medici di base dovrebbero considerare queste soglie differenziate nella valutazione dei pazienti di origine asiatica, sudamericana o africana." },
    { question: "La dieta mediterranea aiuta a mantenere un IMC sano?", answer: "Assolutamente sì. La <strong>dieta mediterranea</strong>, patrimonio UNESCO dal 2010, è scientificamente riconosciuta come modello alimentare ottimale. Lo studio <strong>PREDIMED</strong> ha dimostrato che l'alimentazione ricca di olio extravergine d'oliva, pesce, legumi, cereali integrali e verdure riduce il rischio di obesità del 30%. Le linee guida italiane dell'ex INRAN (oggi <strong>CREA</strong>) raccomandano questo schema alimentare per mantenere un peso corporeo sano e un IMC nella fascia 18,5-24,9." },
    { question: "Il SSN copre i trattamenti per l'obesità?", answer: "Sì. Il <strong>Servizio Sanitario Nazionale</strong> copre i trattamenti per l'obesità attraverso i <strong>LEA</strong> (Livelli Essenziali di Assistenza). Il percorso inizia dal medico di medicina generale (MMG) che rilascia l'impegnativa per visite specialistiche con pagamento del solo ticket. Per la <strong>chirurgia bariatrica</strong>, coperta dal SSN, i criteri sono: IMC ≥40 oppure IMC ≥35 con comorbidità (diabete, ipertensione, apnee notturne). I centri certificati <strong>SICOB</strong> offrono sleeve gastrectomy e bypass gastrico con equipe multidisciplinari." },
    { question: "Cos'è l'obesità sarcopenica?", answer: "L'<strong>obesità sarcopenica</strong> è una condizione in cui si ha un IMC normale o lievemente elevato, ma con perdita significativa di massa muscolare e accumulo di grasso in eccesso. È particolarmente diffusa tra gli <strong>anziani italiani</strong> over 65. I criteri <strong>EWGSOP2</strong> (European Working Group on Sarcopenia) definiscono la sarcopenia come riduzione di forza, massa e funzione muscolare. Il rischio è sottovalutare il problema perché l'IMC appare accettabile. L'allenamento di resistenza e un adeguato apporto proteico (1,2 g/kg/giorno) sono fondamentali per la prevenzione." },
    { question: "Il Nutri-Score è utilizzato in Italia?", answer: "No. L'Italia si <strong>oppone ufficialmente</strong> al Nutri-Score, il sistema a semaforo francese (A-E) per l'etichettatura degli alimenti. Il governo italiano promuove invece il <strong>NutrInform Battery</strong>, che indica la percentuale di energia, grassi, zuccheri e sale per porzione attraverso un'icona a batteria. L'Italia critica il Nutri-Score perché penalizza prodotti DOP come Parmigiano Reggiano e olio d'oliva. Il dibattito con l'UE è ancora in corso, con l'Italia che difende il modello informativo rispetto a quello prescrittivo." },
    { question: "Come influisce la sedentarietà sull'IMC?", answer: "Secondo i dati <strong>ISTAT</strong>, circa il 35% degli italiani è sedentario, con differenze regionali significative: nel <strong>Sud</strong> la percentuale supera il 45%, mentre al Nord scende sotto il 30%. La sedentarietà riduce il metabolismo basale e favorisce l'accumulo di grasso viscerale. L'<strong>OMS</strong> raccomanda almeno 150 minuti di attività aerobica moderata alla settimana (o 75 minuti di attività intensa). Anche 30 minuti di camminata al giorno possono prevenire l'aumento di 1-2 punti di IMC nel corso degli anni." },
  ];
      ...
      <main id="main-content" className="container max-w-4xl py-8 px-4 md:py-12">
        ...
        <div className="glass-card p-8 mt-8">
          ...
          <div className="text-muted-foreground space-y-4">
            ...
            <p>
              In Italia, il <strong>Servizio Sanitario Nazionale (SSN)</strong> garantisce l'accesso gratuito o con ticket ridotto a visite dietologiche e nutrizionali attraverso i <strong>LEA (Livelli Essenziali di Assistenza)</strong>. Il vostro <strong>medico di medicina generale (MMG)</strong> pu&ograve; prescrivere una visita specialistica endocrinologica o dietologica con impegnativa, riducendo significativamente i costi rispetto alla visita privata. Per chi ha un IMC superiore a 30, le ASL offrono percorsi multidisciplinari che includono <strong>dietista, psicologo e fisiatra</strong>, interamente coperti dal SSN. Il sistema di sorveglianza <strong>PASSI</strong> dell'Istituto Superiore di Sanit&agrave; monitora costantemente lo stato ponderale della popolazione italiana e le disuguaglianze nell'accesso alle cure tra le diverse regioni. Per informazioni sui servizi disponibili nel vostro territorio, contattate il vostro medico di base o la ASL di appartenenza.
            </p>
            <p>
              Secondo i dati <strong>ISTAT</strong>, il tasso di obesità in Italia si attesta intorno al <strong>10,5%</strong> della popolazione adulta, un valore inferiore alla media europea (16%), ma in costante aumento negli ultimi vent'anni. Le differenze regionali sono marcate: nel <strong>Sud e nelle Isole</strong> l'obesità è più diffusa, mentre il Nord-Est registra i valori più bassi. Particolarmente preoccupante è l'obesità infantile: il sistema di sorveglianza <strong>OKkio alla SALUTE</strong>, coordinato dall'Istituto Superiore di Sanità, rileva che oltre il 30% dei bambini in <strong>Campania</strong> è in sovrappeso o obeso. Questo programma, attivo dal 2008, monitora ogni due anni le abitudini alimentari e l'attività fisica dei bambini delle scuole primarie, fornendo dati essenziali per le politiche di prevenzione regionali e nazionali.
            </p>
            <p>
              Le autorità sanitarie italiane, in particolare l'<strong>Istituto Superiore di Sanità (ISS)</strong> e il <strong>Ministero della Salute</strong>, raccomandano la <strong>Piramide Alimentare Italiana</strong> come modello di riferimento per un'alimentazione equilibrata. Questo strumento, adattato alla tradizione culinaria del Paese, definisce porzioni standard specifiche per la cucina italiana: 80 g di pasta, 150 g di pesce, 200 g di frutta. La piramide enfatizza il consumo quotidiano di cereali, frutta, verdura e olio extravergine d'oliva, con carne rossa limitata a una volta alla settimana. Il modello alimentare mediterraneo tradizionale, con i suoi pasti strutturati e la convivialità a tavola, aiuta naturalmente a mantenere un IMC sano, contrastando le abitudini del "fast food" che contribuiscono all'aumento ponderale nelle nuove generazioni.
            </p>
          </div>
        </div>
