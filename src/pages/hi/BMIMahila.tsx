    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-6xl py-8 px-4 md:py-12">
        ...
        <div className="space-y-8">
          ...
          {/* भारतीय महिलाओं का दोहरा बोझ — कुपोषण और मोटापा */}
          <div className="glass-card p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 rounded-xl bg-warning/10">
                <AlertTriangle className="w-6 h-6 text-warning" />
              </div>
              <h2 className="text-2xl font-display font-bold">भारतीय महिलाओं का दोहरा बोझ: कुपोषण और मोटापा एक साथ</h2>
            </div>
            <div className="text-muted-foreground space-y-4">
              <p>
                भारत दुनिया का शायद एकमात्र बड़ा देश है जहां <strong>कुपोषण और मोटापा एक साथ महामारी के रूप में</strong> मौजूद हैं, और यह दोहरा बोझ महिलाओं पर सबसे अधिक पड़ता है। <strong>NFHS-5 (2019-21)</strong> के अनुसार, <strong>18.7% भारतीय महिलाएं कम वजन (BMI &lt; 18.5)</strong> की श्रेणी में हैं, जबकि उसी समय <strong>24% महिलाएं WHO मानक से अधिक वजन वाली</strong> हैं। ICMR एशियाई कटऑफ (BMI ≥ 23) के अनुसार यह आंकड़ा <strong>45% से अधिक</strong> है। एक ही परिवार में माँ कम वजन वाली और बेटी मोटापे से ग्रस्त हो सकती है — यह भारत की अनोखी चुनौती है।
              </p>
              <p>
                <strong>राज्यवार भारी अंतर:</strong> केरल, पंजाब, तमिलनाडु और दिल्ली जैसे राज्यों में महिलाओं में मोटापे की दर <strong>30-40%</strong> (ICMR कटऑफ) तक है, जबकि बिहार, झारखंड, मध्य प्रदेश और ओडिशा में <strong>25% से अधिक महिलाएं कम वजन</strong> वाली हैं। शहरी क्षेत्रों में मोटापा प्रमुख समस्या है, जबकि ग्रामीण क्षेत्रों में कुपोषण अभी भी व्यापक है। NFHS-5 से पता चलता है कि शहरी महिलाओं में अधिक वजन की दर <strong>33.2%</strong> है, जबकि ग्रामीण महिलाओं में <strong>19.7%</strong>। यह अंतर पोषण और जीवनशैली की विविधता को दर्शाता है।
              </p>
              <p>
                <strong>52% भारतीय महिलाओं में आयरन की कमी से एनीमिया</strong> है (NFHS-5) — यह आंकड़ा चौंकाने वाला है। एनीमिया और BMI का गहरा संबंध है: एनीमिक महिलाओं में थकान के कारण शारीरिक गतिविधि कम होती है, जिससे मोटापे का जोखिम बढ़ता है। साथ ही, कम वजन वाली महिलाओं में भी एनीमिया अधिक पाया जाता है। <strong>FSSAI के Eat Right India अभियान</strong> और <strong>NIN (राष्ट्रीय पोषण संस्थान)</strong> के आहार दिशानिर्देश इस दोहरे बोझ को संबोधित करने का प्रयास कर रहे हैं।
              </p>
            </div>
          </div>

          {/* गर्भावस्था पोषण और क्षेत्रीय खाद्य विविधता */}
          <div className="glass-card p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 rounded-xl bg-pink-500/10">
                <Baby className="w-6 h-6 text-pink-500" />
              </div>
              <h2 className="text-2xl font-display font-bold">गर्भावस्था पोषण और भारतीय क्षेत्रीय खाद्य विविधता</h2>
            </div>
            <div className="text-muted-foreground space-y-4">
              <p>
                भारत की <strong>अद्वितीय क्षेत्रीय खाद्य विविधता</strong> महिलाओं के BMI और पोषण पर गहरा प्रभाव डालती है। उत्तर भारत में गेहूं आधारित आहार (रोटी, पराठा, पूरी) प्रचलित है जो अधिक कैलोरी वाला होता है, जबकि दक्षिण भारत में चावल आधारित आहार (इडली, डोसा, सांभर) अपेक्षाकृत हल्का होता है। पश्चिम भारत में बाजरा और ज्वार जैसे मोटे अनाज (millets) परंपरागत रूप से खाए जाते थे जो पोषक तत्वों से भरपूर हैं, लेकिन आधुनिकीकरण के साथ इनकी जगह <strong>मैदा और चीनी आधारित खाद्य पदार्थों</strong> ने ले ली है।
              </p>
              <p>
                <strong>गर्भावस्था के दौरान पोषण</strong> भारतीय संदर्भ में विशेष महत्व रखता है। ICMR के अनुसार, गर्भवती भारतीय महिला को प्रतिदिन <strong>अतिरिक्त 350 किलोकैलोरी</strong> (दूसरी और तीसरी तिमाही में) की आवश्यकता होती है। लेकिन भारतीय परिवारों में "दो के लिए खाना" की पारंपरिक मान्यता अक्सर अतिरिक्त खाने को बढ़ावा देती है। <strong>आंगनवाड़ी केंद्र</strong> और <strong>ASHA (मान्यता प्राप्त सामाजिक स्वास्थ्य कार्यकर्ता)</strong> गर्भवती महिलाओं के वजन की नियमित निगरानी करती हैं और पोषण संबंधी सलाह देती हैं।
              </p>
              <p>
                <strong>आयुर्वेदिक दृष्टिकोण से महिला स्वास्थ्य</strong> में शतावरी को "स्त्री रसायन" माना जाता है — यह हार्मोनल संतुलन, प्रजनन स्वास्थ्य और वजन प्रबंधन में सहायक है। आयुर्वेद में <strong>गर्भिणी परिचर्या</strong> (गर्भावस्था की देखभाल) का विस्तृत वर्णन है जिसमें प्रत्येक माह के लिए विशेष आहार निर्धारित है। <strong>त्रिफला, हल्दी दूध (गोल्डन मिल्क)</strong> और <strong>अश्वगंधा</strong> जैसी जड़ी-बूटियां भारतीय महिलाओं की स्वास्थ्य परंपरा का हिस्सा रही हैं। आधुनिक ICMR अनुसंधान भी इनमें से कई जड़ी-बूटियों के लाभों की पुष्टि करता है, लेकिन गर्भावस्था में उपयोग से पहले चिकित्सक से परामर्श आवश्यक है।
              </p>
              <p>
                <strong>मोटे अनाजों (millets) की वापसी</strong> भारतीय महिलाओं के BMI प्रबंधन में एक सकारात्मक विकास है। 2023 को <strong>अंतर्राष्ट्रीय बाजरा वर्ष</strong> घोषित किए जाने के बाद, रागी (Finger Millet), बाजरा (Pearl Millet), ज्वार (Sorghum) और कोदो (Kodo Millet) जैसे पारंपरिक अनाजों को पुनर्जीवित किया जा रहा है। ये अनाज <strong>कम ग्लाइसेमिक इंडेक्स</strong> वाले, फाइबर से भरपूर और आयरन-कैल्शियम के अच्छे स्रोत हैं — भारतीय महिलाओं के लिए आदर्श खाद्य पदार्थ।
              </p>
            </div>
          </div>
