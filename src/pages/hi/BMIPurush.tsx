    ...
    <div className="min-h-screen bg-background">
      ...
      <main id="main-content" className="container max-w-6xl py-8 px-4 md:py-12">
        ...
        <div className="space-y-8">
          ...
          {/* भारतीय पुरुषों में मोटापे के बढ़ते रुझान — NFHS-5 */}
          <div className="glass-card p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 rounded-xl bg-warning/10">
                <AlertTriangle className="w-6 h-6 text-warning" />
              </div>
              <h2 className="text-2xl font-display font-bold">भारतीय पुरुषों में मोटापे के बढ़ते रुझान: NFHS-5 आंकड़े</h2>
            </div>
            <div className="text-muted-foreground space-y-4">
              <p>
                <strong>राष्ट्रीय परिवार स्वास्थ्य सर्वेक्षण (NFHS-5, 2019-21)</strong> ने भारतीय पुरुषों के स्वास्थ्य की एक चिंताजनक तस्वीर पेश की है। WHO मानक (BMI ≥ 25) के अनुसार <strong>22.9% भारतीय पुरुष अधिक वजन वाले</strong> पाए गए, जो NFHS-4 (2015-16) के 18.9% से काफी अधिक है। लेकिन जब <strong>ICMR एशियाई कटऑफ (BMI ≥ 23)</strong> लागू किया जाता है, तो यह आंकड़ा <strong>40% से अधिक</strong> हो जाता है। इसका अर्थ है कि भारत के हर पांच में से दो पुरुष वास्तव में अधिक वजन की श्रेणी में आते हैं।
              </p>
              <p>
                <strong>शहरी और ग्रामीण भारत के बीच भारी अंतर</strong> है। शहरी पुरुषों में मोटापे की दर <strong>28.6%</strong> (WHO मानक) है, जबकि ग्रामीण पुरुषों में यह <strong>18.7%</strong> है। दिल्ली, मुंबई, बेंगलुरु, हैदराबाद और चेन्नई जैसे महानगरों में यह आंकड़ा और भी अधिक है। शहरी जीवनशैली — जैसे लंबे समय तक ऑफिस में बैठना, ऑनलाइन फूड ऑर्डरिंग, वाहनों पर निर्भरता और पैदल चलने की कमी — मोटापे के प्रमुख कारण हैं। इसके विपरीत, ग्रामीण क्षेत्रों में <strong>16% पुरुष अभी भी कम वजन (BMI &lt; 18.5)</strong> वाले हैं, जो भारत के "दोहरे बोझ" की समस्या को दर्शाता है।
              </p>
              <p>
                <strong>भारतीय पुरुषों के लिए BMI कटऑफ अलग क्यों हैं?</strong> ICMR और NIN हैदराबाद के शोध से पता चलता है कि भारतीय पुरुषों में <strong>समान BMI पर यूरोपीय पुरुषों की तुलना में अधिक आंतरिक (विसेरल) चर्बी</strong> होती है। इसलिए भारतीय पुरुषों में <strong>BMI 23 से ही मधुमेह, उच्च रक्तचाप और हृदय रोग का जोखिम</strong> काफी बढ़ जाता है। WHO का 25 का कटऑफ भारतीय पुरुषों के लिए बहुत देर से चेतावनी देता है। ICMR स्पष्ट रूप से कहता है: <strong>भारतीय पुरुषों के लिए अधिक वजन 23 से और मोटापा 25 से शुरू होता है</strong>।
              </p>
            </div>
          </div>

          {/* फिट इंडिया आंदोलन और पुरुष स्वास्थ्य */}
          <div className="glass-card p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 rounded-xl bg-success/10">
                <Dumbbell className="w-6 h-6 text-success" />
              </div>
              <h2 className="text-2xl font-display font-bold">फिट इंडिया आंदोलन और पुरुषों में मधुमेह का संकट</h2>
            </div>
            <div className="text-muted-foreground space-y-4">
              <p>
                भारत सरकार ने 2019 में <strong>फिट इंडिया आंदोलन</strong> की शुरुआत की, जिसका उद्देश्य भारतीयों को शारीरिक रूप से सक्रिय जीवनशैली अपनाने के लिए प्रेरित करना है। यह अभियान विशेष रूप से भारतीय पुरुषों के लिए महत्वपूर्ण है क्योंकि <strong>केवल 10% भारतीय पुरुष</strong> WHO की शारीरिक गतिविधि की न्यूनतम सिफारिशों (सप्ताह में 150 मिनट मध्यम तीव्रता का व्यायाम) को पूरा करते हैं। फिट इंडिया के तहत <strong>फिट इंडिया स्कूल, फिट इंडिया फ्रीडम रन</strong> और <strong>खेलो इंडिया</strong> जैसे कार्यक्रम चलाए जा रहे हैं।
              </p>
              <p>
                <strong>मधुमेह और BMI का संबंध</strong> भारतीय पुरुषों के लिए विशेष रूप से चिंताजनक है। भारत को <strong>"मधुमेह की विश्व राजधानी"</strong> कहा जाता है — ICMR के अनुसार <strong>7.7 करोड़ से अधिक भारतीय पुरुष</strong> मधुमेह से ग्रस्त हैं। सबसे चौंकाने वाली बात यह है कि भारतीय पुरुषों में <strong>BMI 23 से ऊपर होने पर ही मधुमेह का जोखिम दोगुना</strong> हो जाता है, जबकि पश्चिमी देशों में यह जोखिम BMI 27-28 पर बढ़ता है। इसका मतलब है कि एक भारतीय पुरुष जो "सामान्य" दिखता है, वह पहले से ही मधुमेह के उच्च जोखिम में हो सकता है।
              </p>
              <p>
                <strong>भारतीय पुरुषों के लिए व्यावहारिक सुझाव:</strong> प्रतिदिन कम से कम <strong>45 मिनट तेज चलना</strong> (ICMR सिफारिश), सुबह या शाम को <strong>योग और प्राणायाम</strong> का अभ्यास, <strong>भोजन में दालों, सब्जियों और साबुत अनाजों</strong> को प्राथमिकता देना, <strong>तंबाकू और शराब</strong> से परहेज (42.4% भारतीय पुरुष तंबाकू का सेवन करते हैं — GATS India), और <strong>30 वर्ष के बाद वार्षिक स्वास्थ्य जांच</strong> जिसमें रक्त शर्करा, लिपिड प्रोफाइल और BMI शामिल हो। सबसे महत्वपूर्ण बात: <strong>अपने BMI को ICMR कटऑफ (23/25) से मापें, WHO कटऑफ (25/30) से नहीं</strong>।
              </p>
            </div>
          </div>
