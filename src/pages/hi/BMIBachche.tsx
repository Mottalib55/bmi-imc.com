    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-6xl py-8 px-4 md:py-12">
        ...
        <div className="space-y-8">
          ...
          {/* India-Specific Child Nutrition Programs */}
          <div className="glass-card p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 rounded-xl bg-cyan-500/10">
                <Users className="w-6 h-6 text-cyan-500" />
              </div>
              <h2 className="text-2xl font-display font-bold">NFHS-5, ICDS और पोषण अभियान: भारत के बाल पोषण कार्यक्रम</h2>
            </div>
            <div className="text-muted-foreground space-y-4">
              <p>
                <strong>NFHS-5 (राष्ट्रीय परिवार स्वास्थ्य सर्वेक्षण 2019-21)</strong> भारत के बच्चों की
                पोषण स्थिति का सबसे व्यापक आँकड़ा स्रोत है। इसके अनुसार, 5 वर्ष से कम आयु के
                <strong> 35.5% बच्चे ठिगने (stunted)</strong>, <strong>19.3% दुबले (wasted)</strong>, और
                <strong> 32.1% कम वजन (underweight)</strong> हैं। यह भारत का <strong>दोहरा पोषण बोझ</strong> है --
                एक ओर कुपोषण, दूसरी ओर शहरी बच्चों में तेज़ी से बढ़ता मोटापा। NFHS-5 पहली बार
                दिखाता है कि <strong>11 राज्यों</strong> में बाल मोटापे में NFHS-4 (2015-16) की तुलना में वृद्धि हुई है।
              </p>
              <p>
                <strong>ICDS (एकीकृत बाल विकास सेवाएं)</strong> विश्व का सबसे बड़ा बाल विकास कार्यक्रम है,
                जो <strong>13.9 लाख आंगनवाड़ी केंद्रों</strong> के माध्यम से चलता है। ICDS का लक्ष्य 0-6 वर्ष के
                बच्चों, गर्भवती महिलाओं और स्तनपान कराने वाली माताओं को <strong>पूरक पोषाहार, स्वास्थ्य जाँच,
                टीकाकरण संदर्भ, और पोषण शिक्षा</strong> प्रदान करना है। आंगनवाड़ी कार्यकर्ता हर माह बच्चों का
                वजन और ऊँचाई दर्ज करती हैं और गंभीर कुपोषित बच्चों (SAM/MAM) को NRC (पोषण पुनर्वास केंद्र)
                भेजती हैं। यह प्रणाली बच्चों के विकास की प्रारंभिक निगरानी का आधार है।
              </p>
              <p>
                <strong>मध्याह्न भोजन योजना (Mid-Day Meal Scheme)</strong> -- जिसे अब <strong>PM POSHAN</strong>
                कहा जाता है -- विश्व का सबसे बड़ा स्कूल भोजन कार्यक्रम है। यह <strong>11.8 करोड़
                बच्चों</strong> को कक्षा I से VIII तक गर्म पका भोजन प्रदान करता है। इसका उद्देश्य
                <strong> स्कूल उपस्थिति बढ़ाना और कुपोषण कम करना</strong> है। हालाँकि, भोजन की गुणवत्ता
                और पोषण मूल्य में राज्यों के बीच भारी अंतर है। <strong>POSHAN Abhiyaan (राष्ट्रीय पोषण मिशन)</strong>
                2018 में शुरू किया गया था, जिसका लक्ष्य 2022 तक <strong>ठिगनापन 38.4% से 25% तक कम करना</strong>
                था। इस अभियान में <strong>पोषण ट्रैकर ऐप</strong> के माध्यम से प्रत्येक बच्चे का
                वास्तविक समय में विकास डेटा दर्ज किया जाता है -- यह BMI से कहीं अधिक विस्तृत
                और उपयोगी निगरानी प्रणाली है।
              </p>
            </div>
          </div>
