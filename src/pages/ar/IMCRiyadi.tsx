    ...
    <div className="min-h-screen bg-background" dir="rtl">
      ...
      <main id="main-content" className="container max-w-6xl py-8 px-4 md:py-12">
        ...
        <div className="space-y-8">
          ...
          {/* Gulf Athletes & Desert Training */}
          <div className="glass-card p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 rounded-xl bg-orange-500/10">
                <Dumbbell className="w-6 h-6 text-orange-500" />
              </div>
              <h2 className="text-2xl font-display font-bold">رياضيو الخليج والاستثمار الرياضي: تكوين الجسم تحت المجهر</h2>
            </div>
            <div className="text-muted-foreground space-y-6">
              <div>
                <h3 className="font-bold text-foreground mb-2">أكاديمية أسباير (Aspire Academy) في قطر: بروتوكولات تكوين الجسم</h3>
                <p>
                  تُعد أكاديمية أسباير في الدوحة من أبرز مراكز تطوير المواهب الرياضية في العالم. تعتمد الأكاديمية بروتوكولات متقدمة لتقييم تكوين الجسم تتجاوز مؤشر كتلة الجسم التقليدي بشكل كامل. تستخدم الأكاديمية تقنية <strong>DEXA (قياس امتصاص الأشعة السينية ثنائي الطاقة)</strong> لقياس كثافة العظام ونسبة الدهون والكتلة العضلية بدقة عالية لدى الرياضيين الشباب من دول الخليج. كما تعتمد على أجهزة <strong>BOD POD</strong> لقياس حجم الجسم وكثافته عبر إزاحة الهواء، وهي طريقة غير جراحية ودقيقة للغاية. نتائج هذه القياسات تُظهر أن كثيراً من الرياضيين الخليجيين الشباب الذين يُصنفون ضمن "زيادة الوزن" وفق مؤشر كتلة الجسم يمتلكون في الواقع نسبة دهون منخفضة وكتلة عضلية عالية، مما يؤكد قصور المؤشر التقليدي في تقييم اللاعبين.
                </p>
              </div>
              <div>
                <h3 className="font-bold text-foreground mb-2">استثمارات السعودية والإمارات في الرياضة: انعكاسات على تقييم الجسم</h3>
                <p>
                  ضخت المملكة العربية السعودية عبر <strong>صندوق الاستثمارات العامة (PIF)</strong> مليارات الدولارات في القطاع الرياضي، بما فيها الاستحواذ على نادي نيوكاسل يونايتد ودعم بطولات الملاكمة والفورمولا 1 والغولف. هذا التدفق الاستثماري أدى إلى استقطاب مدربين ولاعبين دوليين وفرض معايير تقييم بدني حديثة في الأندية السعودية. لم يعد مؤشر كتلة الجسم كافياً في هذا السياق المهني، حيث تتبنى الأندية الكبرى مثل الهلال والنصر والأهلي أجهزة <strong>InBody</strong> و<strong>التحليل الحيوي الكهربائي (BIA)</strong> لتتبع تكوين أجسام اللاعبين أسبوعياً. في الإمارات، يموّل <strong>مجلس أبوظبي الرياضي</strong> أبحاثاً مشتركة مع جامعات بريطانية حول العلاقة بين تكوين الجسم والأداء الرياضي في المناخ الحار.
                </p>
              </div>
              <div>
                <h3 className="font-bold text-foreground mb-2">المصارعة التقليدية والرياضات التراثية في الخليج</h3>
                <p>
                  إلى جانب الرياضات الحديثة، تحافظ دول الخليج على رياضات تراثية تتطلب أنماطاً جسدية مختلفة تماماً. <strong>المصارعة العمانية (الرزحة)</strong> و<strong>المصارعة الإماراتية (السلمية)</strong> تتطلبان وزناً ثقيلاً وقوة بدنية كبيرة، حيث يكون مؤشر كتلة الجسم لأبطال هذه الرياضات غالباً فوق 28-30. في السعودية، تشهد <strong>رياضة المبارزة بالسيف (العرضة)</strong> اهتماماً متزايداً، وهي تتطلب قوة ذراعين عالية وثبات جسدي. سباق الهجن (الإبل) في الإمارات والسعودية يتطلب خفة الوزن من الفارس مع قدرة تحمل عالية، وهو نمط جسدي مختلف تماماً عن المصارعين. هذا التنوع في الرياضات التراثية يوضح كيف أن مؤشراً واحداً بسيطاً لا يمكن أن يقيّم لياقة جميع الرياضيين.
                </p>
              </div>
              <div>
                <h3 className="font-bold text-foreground mb-2">تأثير المناخ الصحراوي على التدريب وتكوين الجسم</h3>
                <p>
                  يمثل المناخ الصحراوي في دول الخليج تحدياً فريداً لتقييم تكوين الجسم عند الرياضيين. أظهرت دراسات أجرتها <strong>جامعة الملك سعود</strong> بالرياض أن الرياضيين الذين يتدربون في درجات حرارة تتجاوز 40 درجة مئوية يفقدون ما بين 2-4 لترات من العرق في الساعة الواحدة، مما يسبب تذبذباً يومياً في الوزن يصل إلى 3-4 كيلوغرامات. هذا التذبذب يجعل أي قياس لمؤشر كتلة الجسم غير موثوق إذا لم يُأخذ في ظروف ترطيب مضبوطة. كذلك أشارت أبحاث <strong>مستشفى أسبيتار</strong> إلى أن التدريب المتكرر في الحرارة يُحدث تكيفات فسيولوجية تشمل زيادة حجم البلازما في الدم وتغيرات في توزيع السوائل بين الخلايا، وكلها عوامل تؤثر على الوزن دون أن تعكس تغيرات حقيقية في نسبة الدهون أو العضلات. لهذا السبب، توصي مراكز الطب الرياضي في الخليج بإجراء قياسات تكوين الجسم في الصباح الباكر بعد ترطيب كافٍ، وتجنب القياسات بعد التدريبات الخارجية مباشرة.
                </p>
              </div>
              <div>
                <h3 className="font-bold text-foreground mb-2">رياضيات الخليج: بروز على الساحة الدولية</h3>
                <p>
                  شهدت السنوات الأخيرة صعوداً ملحوظاً للرياضيات من دول الخليج في المحافل الدولية. السباحات والعداءات السعوديات والإماراتيات والقطريات يشاركن في الأولمبياد وبطولات العالم، ويحتجن إلى تقييم جسدي يراعي خصوصيات تكوين الجسم الأنثوي. <strong>اللجنة الأولمبية السعودية</strong> أنشأت وحدات طب رياضي مخصصة للنساء تستخدم مقاييس تتجاوز مؤشر كتلة الجسم، بما فيها نسبة الدهون ومستويات الحديد وكثافة العظام. في البحرين، أسست <strong>اللجنة الأولمبية البحرينية</strong> برامج تطوير للرياضيات تشمل متابعة تغذوية شاملة. هذا التطور يعكس إدراكاً متزايداً بأن مؤشر كتلة الجسم لا يصلح أداةً وحيدة لتقييم لياقة الرياضيات العربيات، خاصة مع التباينات الطبيعية في نسبة الدهون بين الجنسين.
                </p>
              </div>
            </div>
          </div>
