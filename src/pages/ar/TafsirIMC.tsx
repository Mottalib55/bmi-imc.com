    ...
    <div className="min-h-screen bg-background" dir="rtl">
      ...
      <div className="container max-w-6xl py-8 px-4 md:py-12">
        ...
        <div className="space-y-8">
          ...
          {/* GCC Healthcare & Bariatric Surgery */}
          <div className="glass-card p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 rounded-xl bg-primary/10">
                <Scale className="w-6 h-6 text-primary" />
              </div>
              <h2 className="text-2xl font-display font-bold">التغطية الصحية لعلاج السمنة والسياحة العلاجية في الخليج</h2>
            </div>
            <div className="text-muted-foreground space-y-4">
              <p>
                تتميز دول مجلس التعاون الخليجي بتغطية صحية شاملة لعلاج السمنة ضمن أنظمتها الصحية الحكومية. في السعودية، تقدم <strong>وزارة الصحة (MOH)</strong> عمليات تكميم المعدة وتحويل المسار مجاناً للمواطنين في المستشفيات الحكومية المتخصصة، حيث أنشأت أكثر من 20 مركزاً لجراحة السمنة في مختلف المناطق. في الإمارات، تغطي <strong>هيئة الصحة بدبي (DHA)</strong> و<strong>شركة أبوظبي للخدمات الصحية (SEHA)</strong> جراحات السمنة للحالات التي يتجاوز مؤشر كتلة جسمها 40 أو 35 مع أمراض مصاحبة، وتشمل التغطية المتابعة الغذائية والنفسية لمدة عامين بعد الجراحة.
              </p>
              <p>
                أصبحت دول الخليج وجهة رئيسية <strong>للسياحة العلاجية في مجال جراحة السمنة</strong>. تستقطب مستشفيات مثل <strong>كليفلاند كلينك أبوظبي</strong> و<strong>مستشفى الملك فيصل التخصصي</strong> في الرياض مرضى من مختلف الدول العربية والآسيوية. تتراوح تكلفة عملية تكميم المعدة في الخليج بين 8,000-15,000 دولار، وهي أقل بكثير من أمريكا وأوروبا مع جودة طبية مماثلة. يقدم الأردن أيضاً خدمات جراحة سمنة متميزة بأسعار تنافسية، مما جعله وجهة شائعة للمرضى من العراق ودول المغرب العربي.
              </p>
              <p>
                يلعب <strong>شهر رمضان</strong> دوراً مهماً في تقلبات مؤشر كتلة الجسم في العالم العربي. أظهرت دراسات أجرتها <strong>جامعة الملك عبدالعزيز</strong> في جدة أن الوزن ينخفض بمعدل 1.5-3 كغ خلال الأسبوعين الأولين من الصيام، لكنه يعود للارتفاع في النصف الثاني بسبب الولائم المسائية والحلويات الرمضانية. الأطباء في المنطقة العربية ينصحون بتجنب قياس مؤشر كتلة الجسم خلال رمضان وخلال أسبوعي عيد الفطر، وتحديد موعد ثابت قبل أو بعد رمضان بشهر للحصول على قراءات دقيقة ومقارنات سنوية موثوقة.
              </p>
            </div>
          </div>
