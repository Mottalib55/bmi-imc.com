        ...
        <div className="space-y-8">
          ...
          <div className="glass-card p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-display font-bold">السمنة عند الرجال في دول الخليج العربي: أرقام مقلقة</h2>
            </div>
            <div className="text-muted-foreground space-y-4">
              <p>
                تُسجّل <strong>دول الخليج العربي</strong> من أعلى معدلات السمنة بين الرجال على مستوى العالم. وفقاً لأحدث البيانات الصادرة عن منظمة الصحة العالمية ووزارات الصحة المحلية، تبلغ نسبة السمنة بين الرجال في <strong>الكويت 37.9%</strong>، وفي <strong>المملكة العربية السعودية 35.4%</strong>، وفي <strong>الإمارات العربية المتحدة 31%</strong>، وفي <strong>قطر 33.2%</strong>، وفي <strong>البحرين 29.8%</strong>. هذه الأرقام تضع رجال الخليج في مقدمة دول العالم من حيث انتشار السمنة بين الذكور البالغين.
              </p>
              <p>
                ترتبط هذه المعدلات المرتفعة ارتباطاً وثيقاً بـ<strong>نمط الحياة الخامل السائد في مدن الخليج</strong>. تعتمد المدن الخليجية على السيارات بشكل شبه كامل في التنقل، حيث صُممت البنية التحتية لخدمة السيارات وليس المشاة. ارتفاع درجات الحرارة لأكثر من <strong>45 درجة مئوية في فصل الصيف</strong> يجعل المشي والأنشطة الخارجية شبه مستحيلة لعدة أشهر من السنة. يقضي الرجل الخليجي معظم وقته متنقلاً بالسيارة بين المنزل والعمل والمراكز التجارية، مما يقلل بشكل حاد من النشاط البدني اليومي ويساهم في تراكم الدهون وارتفاع مؤشر كتلة الجسم.
              </p>
              <p>
                كما أن <strong>طبيعة العمل المكتبي</strong> التي يمارسها غالبية الرجال في دول الخليج تزيد من المشكلة. يعمل الكثير من الرجال في القطاع الحكومي والخاص في وظائف تتطلب الجلوس لفترات طويلة أمام أجهزة الكمبيوتر دون حركة تُذكر. وقد أظهرت الدراسات أن <strong>أقل من 20% من الرجال في دول الخليج</strong> يمارسون النشاط البدني وفقاً لتوصيات منظمة الصحة العالمية (150 دقيقة أسبوعياً من النشاط المعتدل).
              </p>
            </div>
          </div>
          ...
          <div className="glass-card p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-display font-bold">التحول الغذائي: من المطبخ التقليدي إلى الوجبات السريعة</h2>
            </div>
            <div className="text-muted-foreground space-y-4">
              <p>
                شهدت <strong>دول الخليج تحولاً غذائياً جذرياً</strong> خلال العقود الأخيرة. قبل اكتشاف النفط، كان النظام الغذائي التقليدي في الخليج يعتمد على <strong>التمر والسمك والأرز والحبوب البسيطة</strong> مع كميات معتدلة من اللحوم. كان هذا النظام متوازناً نسبياً وتتناسب سعراته الحرارية مع النشاط البدني المطلوب في الحياة اليومية. لكن مع الطفرة الاقتصادية، تغير النمط الغذائي بشكل جذري.
              </p>
              <p>
                أصبحت <strong>مطاعم الوجبات السريعة</strong> منتشرة في كل حي ومركز تجاري في مدن الخليج. يستهلك الرجل الخليجي اليوم سعرات حرارية أعلى بكثير مما يحتاجه جسمه، خاصة من <strong>الأطعمة المعالجة والمقلية والمشروبات الغازية المحلاة</strong>. كما أن عادات الأكل الاجتماعي كالولائم والعزائم التقليدية المتكررة تساهم في استهلاك كميات كبيرة من الطعام. يضاف إلى ذلك أن <strong>الأطباق التقليدية الشعبية</strong> مثل الكبسة والمچبوس والمطبق أصبحت تُحضر بكميات أكبر من الدهون والسمن مقارنة بطريقة تحضيرها الأصلية.
              </p>
              <p>
                <strong>خدمات التوصيل الإلكتروني</strong> عبر التطبيقات (طلبات، هنقرستيشن، كريم) زادت من سهولة الوصول للطعام دون أي جهد بدني. أظهرت دراسة سعودية أن الرجال الذين يطلبون الطعام عبر التطبيقات بانتظام يستهلكون <strong>400-600 سعرة حرارية إضافية يومياً</strong> مقارنة بمن يطبخون في المنزل. هذا التحول في نمط الحياة الغذائي هو عامل رئيسي في ارتفاع مؤشر كتلة الجسم عند الرجال في المنطقة.
              </p>
            </div>
          </div>
          ...
          <div className="glass-card p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-display font-bold">رؤية 2030 والبرامج الصحية لمكافحة سمنة الرجال</h2>
            </div>
            <div className="text-muted-foreground space-y-4">
              <p>
                أطلقت <strong>المملكة العربية السعودية</strong> ضمن رؤية 2030 برامج صحية طموحة تستهدف مكافحة السمنة عند الرجال. يهدف <strong>برنامج جودة الحياة</strong> إلى رفع نسبة ممارسي الرياضة إلى 40% من السكان بحلول 2030، مقارنة بأقل من 13% حالياً. تم إنشاء <strong>مسارات مشي ومضامير جري</strong> في المدن الرئيسية مثل الرياض وجدة والدمام، وافتتاح مرافق رياضية حديثة في الأحياء السكنية.
              </p>
              <p>
                كما أطلقت <strong>وزارة الصحة السعودية</strong> حملات توعوية تستهدف الرجال تحديداً، مثل برنامج <strong>"صحتك في بي إم آي"</strong> الذي يتيح للرجال قياس مؤشر كتلة الجسم ومحيط الخصر في مراكز الرعاية الصحية الأولية مجاناً. وفي الإمارات، أطلقت <strong>هيئة الصحة بدبي</strong> و<strong>دائرة الصحة أبوظبي</strong> مبادرات مشابهة تشمل فحوصات دورية مجانية وبرامج إرشادية لإدارة الوزن.
              </p>
              <p>
                على مستوى بيئة العمل، بدأت شركات كبرى في الخليج بتوفير <strong>صالات رياضية في مقرات العمل</strong> وتقديم وجبات صحية في المطاعم الداخلية. كما أصبحت <strong>تحديات اللياقة البدنية المؤسسية</strong> (مثل تحدي المشي 10,000 خطوة يومياً) شائعة في القطاعين العام والخاص. تُظهر هذه المبادرات تحولاً إيجابياً في الوعي الصحي عند الرجال في دول الخليج، رغم أن الطريق لا يزال طويلاً لتحقيق الأهداف المرجوة في خفض معدلات السمنة.
              </p>
            </div>
          </div>
