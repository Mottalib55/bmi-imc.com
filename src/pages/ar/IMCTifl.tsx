    ...
    <div className="min-h-screen bg-background" dir="rtl">
      ...
      <div className="container max-w-6xl py-8 px-4 md:py-12">
        ...
        <div className="space-y-8">
          ...
          {/* Gulf Childhood Obesity Crisis */}
          <div className="glass-card p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 rounded-xl bg-destructive/10">
                <AlertTriangle className="w-6 h-6 text-destructive" />
              </div>
              <h2 className="text-2xl font-display font-bold">أزمة سمنة الأطفال في الخليج: عوامل ثقافية وغذائية عميقة</h2>
            </div>
            <div className="text-muted-foreground space-y-4">
              <p>
                تكشف بيانات <strong>المكتب الإقليمي لمنظمة الصحة العالمية لشرق المتوسط (WHO EMRO)</strong> أن الكويت تتصدر دول المنطقة بنسبة تقارب 40% من الأطفال الذين يعانون من زيادة الوزن أو السمنة، تليها السعودية بنسبة تتجاوز 35%. هذه النسب تفوق المعدلات العالمية بشكل ملحوظ، وتعكس تحولاً سريعاً في أنماط الحياة لم تشهده المنطقة من قبل.
              </p>
              <p>
                من أبرز العوامل الثقافية المساهمة في هذه الأزمة: <strong>النمط الغذائي المعتمد على الأطعمة المستوردة فائقة التصنيع</strong> الذي حلّ محل الغذاء التقليدي المتوازن. استهلاك العصائر المحلاة بكميات كبيرة ظاهرة خليجية بارزة، حيث تشير دراسات <strong>المعهد القومي للتغذية في مصر (NNI)</strong> إلى أن الأطفال في المنطقة العربية يستهلكون ضعف الكمية الموصى بها من السكريات المضافة يومياً. كذلك، يلعب <strong>نمط الحياة المستقر</strong> في دول الخليج دوراً محورياً: المناخ الحار يحدّ من اللعب في الخارج لأشهر طويلة، والاعتماد الكامل على السيارات ووجود العمالة المنزلية يقلل من الحركة البدنية للأطفال بشكل كبير.
              </p>
              <p>
                استجابت الحكومات الخليجية بإطلاق <strong>برامج وجبات مدرسية صحية</strong>. في السعودية، فرضت وزارة التعليم لوائح صارمة على المقاصف المدرسية تحظر المشروبات الغازية والحلويات فائقة التصنيع وتوجب توفير الفاكهة والخضروات. في الإمارات، تتولى <strong>هيئة أبوظبي للزراعة والسلامة الغذائية</strong> مراقبة جودة الوجبات المدرسية. في الكويت، أطلقت وزارة الصحة مشروعاً وطنياً لمكافحة سمنة الأطفال يشمل فحوصات دورية في المدارس وتوعية أسرية. لكن التحدي يبقى كبيراً، إذ إن العوامل الثقافية متجذرة: ثقافة الضيافة العربية التي تشجع على الإفراط في تقديم الطعام، واعتبار الطفل الممتلئ "صحياً" في الموروث الشعبي، كلها تحتاج إلى تغيير تدريجي عبر التوعية المستمرة.
              </p>
            </div>
          </div>
