...
const BMIFAQDe = () => {
  const faqs = [
    ...
    { question: "Wie berechne ich meinen BMI?", answer: "Um Ihren BMI zu berechnen, teilen Sie Ihr Gewicht in Kilogramm durch das Quadrat Ihrer Größe in Metern. Beispiel: Wenn Sie 70 kg wiegen und 1,75 m groß sind: BMI = 70 / (1,75 × 1,75) = 70 / 3,0625 = <strong>22,9</strong>. Sie können auch unseren <a href='/de/bmi' className='text-primary hover:underline'>kostenlosen BMI-Rechner</a> verwenden." },
